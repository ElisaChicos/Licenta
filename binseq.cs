...
predicate INV(copie: int, nr: int, solutieFinala: seq<int>)
  ...
  decreases copie, nr, solutieFinala
{
...
lemma cazMaxim1(copie: int, nr: int, solutieFinala: seq<int>)
  ...
  decreases copie, nr, solutieFinala
{
  forall solutieCurenta: seq<int> | esteSolutieValida(solutieCurenta) && esteSolutieOptima(solutieCurenta, copie - 1)
    ensures esteSolutieOptima([solutieFinala[0] + solutieCurenta[0] + 1, solutieFinala[1] + solutieCurenta[1], solutieFinala[2] + solutieCurenta[2], solutieFinala[3] + solutieCurenta[3]], nr)
  {
    ...
    assert forall solutieOarecare: seq<int> :: esteSolutieValida(solutieOarecare) && esteSolutie(solutieOarecare, copie - 1) ==> cost(solutieOarecare) >= cost(solutieCurenta);
    assert esteSolutie([solutieFinala[0] + solutieCurenta[0] + 1, solutieFinala[1] + solutieCurenta[1], solutieFinala[2] + solutieCurenta[2], solutieFinala[3] + solutieCurenta[3]], nr);
    assert forall solutieOarecare: seq<int> :: esteSolutieValida(solutieOarecare) && esteSolutie(solutieOarecare, nr) ==> cost(solutieOarecare) >= cost([solutieCurenta[0] + solutieFinala[0] + 1, solutieCurenta[1] + solutieFinala[1], solutieCurenta[2] + solutieFinala[2], solutieCurenta[3] + solutieFinala[3]]);
  }
  assert forall solutieCurenta: seq<int> :: esteSolutieValida(solutieCurenta) && esteSolutieOptima(solutieCurenta, copie - 1) ==> esteSolutieOptima([solutieFinala[0] + solutieCurenta[0] + 1, solutieFinala[1] + solutieCurenta[1], solutieFinala[2] + solutieCurenta[2], solutieFinala[3] + solutieCurenta[3]], nr);
}
...
lemma cazMaxim5(copie: int, nr: int, solutieFinala: seq<int>)
  ...
  decreases copie, nr, solutieFinala
{
  forall solutieCurenta: seq<int> | esteSolutieValida(solutieCurenta) && esteSolutieOptima(solutieCurenta, copie - 5)
    ensures esteSolutieOptima([solutieFinala[0] + solutieCurenta[0], solutieFinala[1] + solutieCurenta[1] + 1, solutieCurenta[2] + solutieFinala[2], solutieCurenta[3] + solutieFinala[3]], nr)
  {
    ...
    assert forall solutieOarecare: seq<int> :: esteSolutieValida(solutieOarecare) && esteSolutie(solutieOarecare, copie - 5) ==> cost(solutieOarecare) >= cost(solutieCurenta);
    ...
    assert forall solutieOarecare: seq<int> :: esteSolutieValida(solutieOarecare) && esteSolutie(solutieOarecare, nr) ==> cost(solutieOarecare) >= cost([solutieFinala[0] + solutieCurenta[0], solutieFinala[1] + solutieCurenta[1] + 1, solutieFinala[2] + solutieCurenta[2], solutieFinala[3] + solutieCurenta[3]]);
  }
  assert forall solutieCurenta: seq<int> :: esteSolutieValida(solutieCurenta) && esteSolutie(solutieCurenta, copie - 5) ==> esteSolutieOptima([solutieCurenta[0] + solutieFinala[0], solutieCurenta[1] + solutieFinala[1] + 1, solutieCurenta[2] + solutieFinala[2], solutieCurenta[3] + solutieFinala[3]], nr);
}
...
lemma aux2(copie: int, solutieCurenta: seq<int>)
  ...
  decreases copie, solutieCurenta
{
...
lemma cazMaxim10(copie: int, nr: int, solutieFinala: seq<int>)
  ...
  decreases copie, nr, solutieFinala
{
  forall solutieCurenta: seq<int> | esteSolutieValida(solutieCurenta) && esteSolutieOptima(solutieCurenta, copie - 10)
    ensures esteSolutieOptima([solutieFinala[0] + solutieCurenta[0], solutieFinala[1] + solutieCurenta[1], solutieCurenta[2] + solutieFinala[2] + 1, solutieCurenta[3] + solutieFinala[3]], nr)
  {
    ...
    assert forall solutieOarecare: seq<int> :: esteSolutieValida(solutieOarecare) && esteSolutie(solutieOarecare, copie - 10) ==> cost(solutieOarecare) >= cost(solutieCurenta);
    assert esteSolutie([solutieFinala[0] + solutieCurenta[0], solutieFinala[1] + solutieCurenta[1], 1 + solutieFinala[2] + solutieCurenta[2], solutieFinala[3] + solutieCurenta[3]], nr);
    assert forall solutieOarecare: seq<int> :: esteSolutieValida(solutieOarecare) && esteSolutie(solutieOarecare, nr) ==> cost(solutieOarecare) >= cost([solutieCurenta[0] + solutieFinala[0], solutieCurenta[1] + solutieFinala[1], solutieCurenta[2] + solutieFinala[2] + 1, solutieCurenta[3] + solutieFinala[3]]);
  }
  assert forall solutieCurenta: seq<int> :: esteSolutieValida(solutieCurenta) && esteSolutieOptima(solutieCurenta, copie - 10) ==> esteSolutieOptima([solutieCurenta[0] + solutieFinala[0], solutieCurenta[1] + solutieFinala[1], solutieCurenta[2] + solutieFinala[2] + 1, solutieCurenta[3] + solutieFinala[3]], nr);
}
  ...
  if cost(solutieOarecare) < cost([solutieCurenta[0], solutieCurenta[1], solutieCurenta[2], 1 + solutieCurenta[3]]) {
    if solutieOarecare[3] > solutieCurenta[3] + 1 {
      ...
      if solutieOarecare[2] >= 2 {
        ghost var nouaSolutieOarecare := [solutieOarecare[0], solutieOarecare[1], solutieOarecare[2] - 2, solutieOarecare[3] + 1];
        B(copie, nr, nouaSolutieOarecare, solutieCurenta);
      } else if solutieOarecare[2] >= 1 && solutieOarecare[1] >= 2 {
        ghost var nouaSolutieOarecare := [solutieOarecare[0], solutieOarecare[1] - 2, solutieOarecare[2] - 1, solutieOarecare[3] + 1];
        B(copie, nr, nouaSolutieOarecare, solutieCurenta);
      } else if solutieOarecare[2] >= 1 && solutieOarecare[1] >= 1 && solutieOarecare[0] >= 5 {
        ghost var nouaSolutieOarecare := [solutieOarecare[0] - 5, solutieOarecare[1] - 1, solutieOarecare[2] - 1, solutieOarecare[3] + 1];
        B(copie, nr, nouaSolutieOarecare, solutieCurenta);
      } else if solutieOarecare[1] >= 4 {
        ghost var nouaSolutieOarecare := [solutieOarecare[0], solutieOarecare[1] - 4, solutieOarecare[2], solutieOarecare[3] + 1];
        B(copie, nr, nouaSolutieOarecare, solutieCurenta);
      } else if solutieOarecare[1] >= 3 && solutieOarecare[0] >= 5 {
        ghost var nouaSolutieOarecare := [solutieOarecare[0] - 5, solutieOarecare[1] - 3, solutieOarecare[2], solutieOarecare[3] + 1];
        B(copie, nr, nouaSolutieOarecare, solutieCurenta);
      } else if solutieOarecare[1] >= 2 && solutieOarecare[0] >= 10 {
        ghost var nouaSolutieOarecare := [solutieOarecare[0] - 10, solutieOarecare[1] - 2, solutieOarecare[2], solutieOarecare[3] + 1];
        B(copie, nr, nouaSolutieOarecare, solutieCurenta);
      } else if solutieOarecare[1] >= 1 && solutieOarecare[0] >= 15 {
        ghost var nouaSolutieOarecare := [solutieOarecare[0] - 15, solutieOarecare[1] - 1, solutieOarecare[2], solutieOarecare[3] + 1];
        B(copie, nr, nouaSolutieOarecare, solutieCurenta);
      } else if solutieOarecare[0] >= 20 {
        ghost var nouaSolutieOarecare := [solutieOarecare[0] - 20, solutieOarecare[1], solutieOarecare[2], solutieOarecare[3] + 1];
        B(copie, nr, nouaSolutieOarecare, solutieCurenta);
      } else if solutieOarecare[2] >= 1 && solutieOarecare[0] >= 10 {
        ghost var nouaSolutieOarecare := [solutieOarecare[0] - 10, solutieOarecare[1], solutieOarecare[2] - 1, solutieOarecare[3] + 1];
        B(copie, nr, nouaSolutieOarecare, solutieCurenta);
      }
    }
    ...
    if solutieOarecare[2] > solutieCurenta[2] {
      ...
      if solutieOarecare[0] >= 10 {
        ghost var nouaSolutieOarecare := [solutieOarecare[0] - 10, solutieOarecare[1], solutieOarecare[2] + 1, solutieOarecare[3]];
        B(copie, nr, nouaSolutieOarecare, solutieCurenta);
      } else if solutieOarecare[1] >= 2 {
        ghost var nouaSolutieOarecare := [solutieOarecare[0], solutieOarecare[1] - 2, solutieOarecare[2] + 1, solutieOarecare[3]];
        B(copie, nr, nouaSolutieOarecare, solutieCurenta);
      } else {
        ghost var nouaSolutieOarecare := [solutieOarecare[0] - 5, solutieOarecare[1] - 1, solutieOarecare[2] + 1, solutieOarecare[3]];
        B(copie, nr, nouaSolutieOarecare, solutieCurenta);
      }
    }
    ...
    if solutieOarecare[1] > solutieCurenta[1] {
      ...
      if solutieOarecare[1] < solutieCurenta[1] {
        ...
        ghost var nouaSolutieOarecare := [solutieOarecare[0] - 5, solutieOarecare[1] + 1, solutieOarecare[2], solutieOarecare[3]];
        B(copie, nr, nouaSolutieOarecare, solutieCurenta);
      }
    }
...
lemma esteSolutiePentruCopie(copie: int, nr: int, solutieCurenta: seq<int>)
  ...
  requires esteSolutieOptima(solutieCurenta, copie - 20)
  ensures esteSolutieOptima([solutieCurenta[0], solutieCurenta[1], solutieCurenta[2], 1 + solutieCurenta[3]], copie)
  decreases copie, nr, solutieCurenta
{
  forall solutieOarecare: seq<int> | esteSolutieValida(solutieOarecare) && esteSolutie(solutieOarecare, copie)
    ensures cost(solutieOarecare) >= cost([solutieCurenta[0], solutieCurenta[1], solutieCurenta[2], 1 + solutieCurenta[3]])
  {
...
lemma aux(copie: int, nr: int, solutieOarecare: seq<int>, solutieFinala: seq<int>, solutieCurenta: seq<int>)
  ...
  decreases copie, nr, solutieOarecare, solutieFinala, solutieCurenta
{
...
lemma cazMaxim20(copie: int, nr: int, solutieFinala: seq<int>)
  ...
  decreases copie, nr, solutieFinala
{
  assert forall solutieCurenta: seq<int> :: esteSolutieValida(solutieCurenta) ==> esteSolutie(solutieCurenta, copie) ==> esteSolutie([solutieFinala[0] + solutieCurenta[0], solutieFinala[1] + solutieCurenta[1], solutieFinala[2] + solutieCurenta[2], solutieFinala[3] + solutieCurenta[3]], nr);
  forall solutieCurenta: seq<int> | esteSolutieValida(solutieCurenta) && esteSolutie(solutieCurenta, copie - 20)
  ...
  forall solutieCurenta: seq<int> | esteSolutieValida(solutieCurenta) && esteSolutieOptima(solutieCurenta, copie - 20)
    ensures esteSolutieOptima([solutieFinala[0] + solutieCurenta[0], solutieFinala[1] + solutieCurenta[1], solutieFinala[2] + solutieCurenta[2], solutieFinala[3] + solutieCurenta[3] + 1], nr)
  {
    ...
    assert esteSolutie([solutieCurenta[0], solutieCurenta[1], solutieCurenta[2], solutieCurenta[3] + 1], copie);
    assert forall solutieOarecare: seq<int> :: esteSolutieValida(solutieOarecare) && esteSolutie(solutieOarecare, copie - 20) ==> cost(solutieOarecare) >= cost(solutieCurenta);
    ...
    forall solutieOarecare: seq<int> | esteSolutieValida(solutieOarecare) && esteSolutie(solutieOarecare, nr)
      ensures cost(solutieOarecare) >= cost([solutieFinala[0] + solutieCurenta[0], solutieFinala[1] + solutieCurenta[1], solutieFinala[2] + solutieCurenta[2], 1 + solutieFinala[3] + solutieCurenta[3]])
    {
      aux(copie, nr, solutieOarecare, solutieFinala, solutieCurenta);
    }
    assert forall solutieOarecare: seq<int> :: esteSolutieValida(solutieOarecare) && esteSolutie(solutieOarecare, nr) ==> cost(solutieOarecare) >= cost([solutieFinala[0] + solutieCurenta[0], solutieFinala[1] + solutieCurenta[1], solutieFinala[2] + solutieCurenta[2], 1 + solutieFinala[3] + solutieCurenta[3]]);
  }
  assert forall solutieCurenta: seq<int> :: esteSolutieValida(solutieCurenta) && esteSolutieOptima(solutieCurenta, copie - 20) ==> esteSolutieOptima([solutieFinala[0] + solutieCurenta[0], solutieFinala[1] + solutieCurenta[1], solutieFinala[2] + solutieCurenta[2], 1 + solutieFinala[3] + solutieCurenta[3]], nr);
  assert forall solutieCurenta: seq<int> :: esteSolutieValida(solutieCurenta) ==> esteSolutie(solutieCurenta, copie - 20) ==> esteSolutie([solutieFinala[0] + solutieCurenta[0], solutieFinala[1] + solutieCurenta[1], solutieFinala[2] + solutieCurenta[2], 1 + solutieFinala[3] + solutieCurenta[3]], nr);
  assert forall solutieCurenta: seq<int> :: esteSolutieValida(solutieCurenta) ==> esteSolutieOptima(solutieCurenta, copie - 20) ==> esteSolutieOptima([solutieFinala[0] + solutieCurenta[0], solutieFinala[1] + solutieCurenta[1], solutieFinala[2] + solutieCurenta[2], solutieFinala[3] + solutieCurenta[3] + 1], nr);
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger gasireMaxim(BigInteger nr)
    {
      BigInteger s = BigInteger.Zero;
      if ((nr) >= (new BigInteger(20))) {
        s = new BigInteger(20);
      } else if ((nr) >= (new BigInteger(10))) {
        s = new BigInteger(10);
      } else if ((nr) >= (new BigInteger(5))) {
        s = new BigInteger(5);
      } else if ((nr) < (new BigInteger(5))) {
        s = BigInteger.One;
      }
    ...
    public static Dafny.ISequence<BigInteger> nrMinimBancnote(BigInteger nr)
    {
      ...
      while ((_0_copie).Sign == 1) {
        BigInteger _5_i;
        _5_i = BigInteger.Zero;
        BigInteger _6_s;
        BigInteger _out0;
        _out0 = __default.gasireMaxim(_0_copie);
        _6_s = _out0;
        if ((_6_s) == (BigInteger.One)) {
          _1_s1 = (_1_s1) + (BigInteger.One);
        } else if ((_6_s) == (new BigInteger(5))) {
          _2_s5 = (_2_s5) + (BigInteger.One);
        } else if ((_6_s) == (new BigInteger(10))) {
          _3_s10 = (_3_s10) + (BigInteger.One);
        } else {
          _4_s20 = (_4_s20) + (BigInteger.One);
        }
        _0_copie = (_0_copie) - (_6_s);
      }
      solutie = Dafny.Sequence<BigInteger>.FromElements(_1_s1, _2_s5, _3_s10, _4_s20);
      return solutie;
    }
    public static void _Main()
    {
      BigInteger _7_nr;
      _7_nr = new BigInteger(58);
      Dafny.ISequence<BigInteger> _8_sol;
      Dafny.ISequence<BigInteger> _out1;
      _out1 = __default.nrMinimBancnote(_7_nr);
      _8_sol = _out1;
      Dafny.Helpers.Print(_8_sol);
    }
  }
